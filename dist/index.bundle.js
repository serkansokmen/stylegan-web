(function () {
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-d3e9d6e6_0", { source: "\n.storeinput[data-v-d3e9d6e6]\n{\n\tposition: relative;\n}\n", map: {"version":3,"sources":["/home/sokemon/Desktop/WORKS/stylegan-web/app/storeinput.vue"],"names":[],"mappings":";AAwFA;;CAEA,kBAAA;AACA","file":"storeinput.vue","sourcesContent":["<template>\r\n\t<span class=\"storeinput\">\r\n\t\t<input\r\n\t\t\t:type=\"type\"\r\n\t\t\tv-model.lazy=\"innerValue\"\r\n\t\t\t:style=\"styleObj\"\r\n\t\t\t:placeholder=\"placeholder\"\r\n\t\t\t:min=\"range && range.min\"\r\n\t\t\t:max=\"range && range.max\"\r\n\t\t\t:step=\"range && range.step\"\r\n\t\t\t:disabled=\"disabled\"\r\n\t\t/>\r\n\t</span>\r\n</template>\r\n\r\n<script>\r\n\texport default {\r\n\t\tname: \"store-input\",\r\n\r\n\r\n\t\tprops: {\r\n\t\t\ttype: {\r\n\t\t\t\ttype: String,\r\n\t\t\t\tdefault: \"text\",\r\n\t\t\t},\r\n\r\n\t\t\tvalue: {\r\n\t\t\t\tvalidator () {return true;},\r\n\t\t\t},\r\n\r\n\t\t\trange: Object,\r\n\r\n\t\t\tstyleObj: Object,\r\n\r\n\t\t\tplaceholder: String,\r\n\r\n\t\t\tlocalKey: String,\r\n\t\t\tsessionKey: String,\r\n\r\n\t\t\tdisabled: Boolean,\r\n\t\t},\r\n\r\n\r\n\t\tcomputed: {\r\n\t\t\tinnerValue: {\r\n\t\t\t\tget () {\r\n\t\t\t\t\treturn this.value;\r\n\t\t\t\t},\r\n\r\n\t\t\t\tset (value) {\r\n\t\t\t\t\tthis.$emit(\"input\", value);\r\n\t\t\t\t},\r\n\t\t\t},\r\n\t\t},\r\n\r\n\r\n\t\tcreated () {\r\n\t\t\tthis.load();\r\n\t\t},\r\n\r\n\r\n\t\tmethods: {\r\n\t\t\tload () {\r\n\t\t\t\tif (this.localKey && localStorage[`storeInput-${this.localKey}`])\r\n\t\t\t\t\tthis.innerValue = JSON.parse(localStorage[`storeInput-${this.localKey}`]);\r\n\r\n\t\t\t\tif (this.sessionKey && sessionStorage[`storeInput-${this.sessionKey}`])\r\n\t\t\t\t\tthis.innerValue = JSON.parse(sessionStorage[`storeInput-${this.sessionKey}`]);\r\n\t\t\t},\r\n\r\n\r\n\t\t\tsave () {\r\n\t\t\t\tif (this.localKey)\r\n\t\t\t\t\tlocalStorage[`storeInput-${this.localKey}`] = JSON.stringify(this.value);\r\n\r\n\t\t\t\tif (this.sessionKey)\r\n\t\t\t\t\tsessionStorage[`storeInput-${this.sessionKey}`] = JSON.stringify(this.value);\r\n\t\t\t},\r\n\t\t},\r\n\r\n\r\n\t\twatch: {\r\n\t\t\tvalue: \"save\",\r\n\t\t},\r\n\t};\r\n</script>\r\n\r\n<style scoped>\r\n\t.storeinput\r\n\t{\r\n\t\tposition: relative;\r\n\t}\r\n</style>\r\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-d3e9d6e6";
    /* module identifier */
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-60a842ef_0", { source: "\nheader[data-v-60a842ef]\n{\n\tposition: fixed;\n\tleft: 0;\n\ttop: 0;\n\tmargin: 0;\n\tpadding: 0 0.4em;\n\tfont-size: 10px;\n\theight: unset;\n\tcolor: white;\n\tbackground: #333;\n\tborder-bottom-right-radius: 1em;\n}\nheader > a[data-v-60a842ef]\n{\n\tdisplay: inline-block;\n\tpadding: 0 1em;\n\tcolor: inherit;\n\ttext-decoration: none;\n\tborder-width: 2px;\n\tborder-color: transparent;\n}\nheader > a[data-v-60a842ef]:hover\n{\n\tbackground: #c00;\n}\nheader > a.focus[data-v-60a842ef]\n{\n\tborder-bottom: 2px solid white;\n\tfont-weight: bold;\n}\n", map: {"version":3,"sources":["/home/sokemon/Desktop/WORKS/stylegan-web/app/navigator.vue"],"names":[],"mappings":";AAkCA;;CAEA,eAAA;CACA,OAAA;CACA,MAAA;CACA,SAAA;CACA,gBAAA;CACA,eAAA;CACA,aAAA;CACA,YAAA;CACA,gBAAA;CACA,+BAAA;AACA;AAEA;;CAEA,qBAAA;CACA,cAAA;CACA,cAAA;CACA,qBAAA;CACA,iBAAA;CACA,yBAAA;AACA;AAEA;;CAEA,gBAAA;AACA;AAEA;;CAEA,8BAAA;CACA,iBAAA;AACA","file":"navigator.vue","sourcesContent":["<template>\n\t<header>\n\t\t<a v-for=\"link of links\" :href=\"link.href\" :class=\"{focus: link.href === pathname}\">{{link.name}}</a>\n\t</header>\n</template>\n\n<script>\n\texport default {\n\t\tname: \"navigator\",\n\n\n\t\tdata() {\n\t\t\treturn {\n\t\t\t\tlinks: [\n\t\t\t\t\t{\n\t\t\t\t\t\thref: \"/\",\n\t\t\t\t\t\tname: \"EXPLORER\",\n\t\t\t\t\t},\n\t\t\t\t\t{\n\t\t\t\t\t\thref: \"/projector/\",\n\t\t\t\t\t\tname: \"PROJECTOR\",\n\t\t\t\t\t},\n\t\t\t\t\t{\n\t\t\t\t\t\thref: \"/merger/\",\n\t\t\t\t\t\tname: \"MERGER\",\n\t\t\t\t\t},\n\t\t\t\t],\n\t\t\t\tpathname: location.pathname,\n\t\t\t};\n\t\t},\n\t};\n</script>\n\n<style scoped>\n\theader\n\t{\n\t\tposition: fixed;\n\t\tleft: 0;\n\t\ttop: 0;\n\t\tmargin: 0;\n\t\tpadding: 0 0.4em;\n\t\tfont-size: 10px;\n\t\theight: unset;\n\t\tcolor: white;\n\t\tbackground: #333;\n\t\tborder-bottom-right-radius: 1em;\n\t}\n\n\theader > a\n\t{\n\t\tdisplay: inline-block;\n\t\tpadding: 0 1em;\n\t\tcolor: inherit;\n\t\ttext-decoration: none;\n\t\tborder-width: 2px;\n\t\tborder-color: transparent;\n\t}\n\n\theader > a:hover\n\t{\n\t\tbackground: #c00;\n\t}\n\n\theader > a.focus\n\t{\n\t\tborder-bottom: 2px solid white;\n\t\tfont-weight: bold;\n\t}\n</style>\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$1 = "data-v-60a842ef";
    /* module identifier */
